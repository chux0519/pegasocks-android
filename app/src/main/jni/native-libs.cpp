...
Java_com_hexyoungs_pegasocks_NativeLibs__1startTun2Socks(JNIEnv *env, jobject thiz,
                                                         jobjectArray args) {
    // argc
...
extern "C"
JNIEXPORT void JNICALL
Java_com_hexyoungs_pegasocks_NativeLibs_stopTun2Socks(JNIEnv *env, jobject thiz) {
    tun2socks_terminate();
}